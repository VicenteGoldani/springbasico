...
public class ExemploController {
    ...
    // Query string: /biblioteca/livrosautor?autor=Maria da Silva
    ...
    // Path parameters: /biblioteca/livrosautorano/{autor}/ano/{ano}
    @GetMapping("/livrosautorano/{autor}/ano/{ano}")
    public List<Livro> getLivrosDoAutorEAno(@PathVariable(value = "autor") String autor,
    ...
    // Body data: POST /biblioteca/novolivro
    ...
    // Response Entity: /biblioteca/livrotitulo/{titulo}
